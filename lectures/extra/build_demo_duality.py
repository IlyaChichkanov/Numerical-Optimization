"""Собирает ноутбук demo_duality.ipynb к заготовке duality.md.
...
OUT = Path(__file__).resolve().parent / "demo_duality.ipynb"
...
# ============================================================ 0. шапка
md(r"""# Демонстрации к заготовке «Двойственность Лагранжа»: руками и кодом
...
Конспект: [`duality.md`](duality.md). Запуск: `uv run jupyter lab` в корне репозитория.""")
...
md(r"""**Тот же множитель из баланса сил** (лекция 3, раздел о силах). Двойственную задачу можно вообще не решать: в решении градиент цели должен быть уравновешен реакцией активных стенок, $
...
md(r"""**Теневые цены — это коэффициенты разложения градиента** (лекция 3, картинка с конусом нормалей). В вершине $(2,6)$ активны ограничения 2 и 3; их внешние нормали — строки $a_2=(0,2)$ и $a_3=(3,2)$ матрицы $A$. Разложим градиент прибыли $c=(3,5)$ по этим двум векторам — получится $y_2^st, y_3^st$, а у неактивного ограничения 1 вес нулевой.""")
